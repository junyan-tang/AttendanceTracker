...
public class App {
  ...
  public static void main(String[] args) throws IOException {
    ...
    // } else {
    // System.out.println("Login failed, username or password is wrong. Please try
    // again.");
    // }
    // }
    ...
    // InputFilter inputFilter = new InputFilter(fileReader, consoleReader,
    // System.out);
    ...
    // Lecture new_lecture = new Lecture(courseId, courseName, new
    // LinkedHashMap<String, User>(),
    // new LinkedHashMap<String, User>(), new LinkedHashMap<String, Attendance>(),
    // new EmailSender());
    ...
    // break;
    // case "3":
    // System.out.println("You have chosen to enroll new student to course.");
